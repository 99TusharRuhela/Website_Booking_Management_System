    ...
    if not product_record.is_available_booking:
        ...
        if line_id is not False:
            ...
            for order_line_rec in order_line_obj:
                if order_line_rec:
                    if order_line_rec.user_id.id == current_uid and order_line_rec.booking_time_slot == kwargs.get("book_time") and order_line_rec.booking_date == kwargs.get("book_date") and order_line_rec.booking_plan == kwargs.get("book_plan"):
